...
window.customElements.define('defly-wallet-modal-desktop-mode', DeflyWalletModalDesktopMode);
window.customElements.define('defly-wallet-modal-header', DeflyWalletModalHeader);
window.customElements.define('defly-wallet-modal-touch-screen-mode', DeflyWalletModalTouchScreenMode);
